...
$loginUrl = $facebook->getLoginUrl(array ( 
        'display' => 'page',
        'redirect_uri' => 'http://liked.ro/apps/hai-simona/'
        ));
   ...
   <?php
	...
	if(isset($_GET["save"])) {
		...
		$create_album = $facebook->api('/me/albums', 'post', $album_details);
		  ...
		  $photo_details = array('message'=> 'Hai Simona!');
      	...
      	?>
      	<a href="index.php?save=1">ACCEPTĂ POZA</a>
...
<div class="banda"></div>
<div class="statement">
	<p>Aceasta este o intiativa voluntara, neafiliata unui brand sau unei campanii. <span>Pentru ca trebuie să ne sustinem valorile fara a ni
se vinde ceva in același timp.</span> Pentru ca momentele de bucurie nu trebuie marcate ca publicitate. <span>Pentru că nimeni nu are
dreptul să ne spună cum să trăim clipe atât de prețioase.</span> Hai Simona! Hai România!</p>
